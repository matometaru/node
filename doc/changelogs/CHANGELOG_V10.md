...
* [[`1ec6923276`](https://github.com/nodejs/node/commit/1ec6923276)] - **test**: compareobjects not identical by reference (Marie Terrier) [#24189](https://github.com/nodejs/node/pull/24189)
...
* [[`e26c4d4170`](https://github.com/nodejs/node/commit/e26c4d4170)] - **build**: fixPython detection when depot\_tools are in PATH in Windows (Guy Bedford) [#22539](https://github.com/nodejs/node/pull/22539)
* [[`aa7fd82653`](https://github.com/nodejs/node/commit/aa7fd82653)] - **build**: remove sudo:false from .travis.yml (Rich Trott) [#24511](https://github.com/nodejs/node/pull/24511)
* [[`9967d0f6ef`](https://github.com/nodejs/node/commit/9967d0f6ef)] - **build**: useprint() function in configure.py (cclauss) [#24484](https://github.com/nodejs/node/pull/24484)
* [[`c0f0d19621`](https://github.com/nodejs/node/commit/c0f0d19621)] - **build**: check minimum ICU in configure for system-icu (Steven R. Loomis) [#24255](https://github.com/nodejs/node/pull/24255)
* [[`ff2de6e14e`](https://github.com/nodejs/node/commit/ff2de6e14e)] - **build**: remove unnecessary prerequisite in Makefile (Rich Trott) [#24342](https://github.com/nodejs/node/pull/24342)
* [[`33fd13c5ce`](https://github.com/nodejs/node/commit/33fd13c5ce)] - **build**: fixbenchmark tests on CI (Rich Trott) [#24307](https://github.com/nodejs/node/pull/24307)
* [[`07b7db2f81`](https://github.com/nodejs/node/commit/07b7db2f81)] - **build**: useBUILDTYPE in bench-addons-build targets (Daniel Bevenius) [#24033](https://github.com/nodejs/node/pull/24033)
...
* [[`4d31b3a6f3`](https://github.com/nodejs/node/commit/4d31b3a6f3)] - **build,tools**: update make-v8.sh for ppc64le (Refael Ackermann) [#24293](https://github.com/nodejs/node/pull/24293)
...
* [[`8314cde88f`](https://github.com/nodejs/node/commit/8314cde88f)] - **cli**: add missing env vars to --help (cjihrig) [#24383](https://github.com/nodejs/node/pull/24383)
* [[`38527a00b7`](https://github.com/nodejs/node/commit/38527a00b7)] - **console**: improve code readability (gengjiawen) [#24412](https://github.com/nodejs/node/pull/24412)
...
* [[`72f10a472b`](https://github.com/nodejs/node/commit/72f10a472b)] - **deps**: upgrade to libuv 1.24.0 (cjihrig) [#24332](https://github.com/nodejs/node/pull/24332)
...
* [[`10055524d3`](https://github.com/nodejs/node/commit/10055524d3)] - **doc**: clarify who may land on an LTS staging branch (Myles Borins) [#24465](https://github.com/nodejs/node/pull/24465)
* [[`6acd1053b2`](https://github.com/nodejs/node/commit/6acd1053b2)] - **doc**: revise `author ready` explanation (Rich Trott) [#24558](https://github.com/nodejs/node/pull/24558)
* [[`89bfeca837`](https://github.com/nodejs/node/commit/89bfeca837)] - **doc**: add readable and writable property to Readable and Writable (Dexter Leng) [#23933](https://github.com/nodejs/node/pull/23933)
* [[`d243c4d4a0`](https://github.com/nodejs/node/commit/d243c4d4a0)] - **doc**: move trott to tsc emeritus (Rich Trott) [#24492](https://github.com/nodejs/node/pull/24492)
* [[`b0d265ca37`](https://github.com/nodejs/node/commit/b0d265ca37)] - **doc**: add Ruben Bridgewater to release team (Ruben Bridgewater) [#23432](https://github.com/nodejs/node/pull/23432)
* [[`c91228c353`](https://github.com/nodejs/node/commit/c91228c353)] - **doc**: edit COLLABORATOR\_GUIDE.md on closing issues (Rich Trott) [#24477](https://github.com/nodejs/node/pull/24477)
* [[`236181abc4`](https://github.com/nodejs/node/commit/236181abc4)] - **doc**: move Timothy to TSC emeritus (Timothy Gu) [#24535](https://github.com/nodejs/node/pull/24535)
* [[`daf9dced8c`](https://github.com/nodejs/node/commit/daf9dced8c)] - **doc**: add NODE\_DEBUG\_NATIVE to API docs (cjihrig) [#24383](https://github.com/nodejs/node/pull/24383)
* [[`3b44aed434`](https://github.com/nodejs/node/commit/3b44aed434)] - **doc**: add missing env variables to man page (cjihrig) [#24383](https://github.com/nodejs/node/pull/24383)
* [[`5972695259`](https://github.com/nodejs/node/commit/5972695259)] - **doc**: minorcleanup of tls.getProtocol() (Sam Roberts) [#24533](https://github.com/nodejs/node/pull/24533)
* [[`f001ba7c78`](https://github.com/nodejs/node/commit/f001ba7c78)] - **doc**: add Beth Griggs to release team (Beth Griggs) [#24532](https://github.com/nodejs/node/pull/24532)
* [[`e2970040d4`](https://github.com/nodejs/node/commit/e2970040d4)] - **doc**: add filehandle.write(string\[, position\[, encoding\]\]) (Dara Hayes) [#23224](https://github.com/nodejs/node/pull/23224)
* [[`a1dcb317a9`](https://github.com/nodejs/node/commit/a1dcb317a9)] - **doc**: udpate list item spacing in changelogs (Rich Trott) [#24391](https://github.com/nodejs/node/pull/24391)
* [[`8475fb1750`](https://github.com/nodejs/node/commit/8475fb1750)] - **doc**: update crypto examples to not use deprecated api (Mayank Asthana) [#24107](https://github.com/nodejs/node/pull/24107)
* [[`6fcf5654ad`](https://github.com/nodejs/node/commit/6fcf5654ad)] - **doc**: simplify first-time contributors section of Collaborator Guide (Rich Trott) [#24387](https://github.com/nodejs/node/pull/24387)
* [[`016ac8b26e`](https://github.com/nodejs/node/commit/016ac8b26e)] - **doc**: adjusting formatting when printing (Thomas Hunter II) [#24325](https://github.com/nodejs/node/pull/24325)
* [[`25f2bf7153`](https://github.com/nodejs/node/commit/25f2bf7153)] - **doc**: better linkage to node-addon-api (Michael Dawson) [#24371](https://github.com/nodejs/node/pull/24371)
* [[`37c9a83d3f`](https://github.com/nodejs/node/commit/37c9a83d3f)] - **doc**: update collaborator guide with LTS labels (Charalampos Fanoulis) [#24379](https://github.com/nodejs/node/pull/24379)
...
* [[`b4494ee037`](https://github.com/nodejs/node/commit/b4494ee037)] - **doc,meta**: update PR approving info (Vse Mozhet Byt) [#24561](https://github.com/nodejs/node/pull/24561)
* [[`d94740d8fa`](https://github.com/nodejs/node/commit/d94740d8fa)] - **events**: extract listener check as a function (ZYSzys) [#24303](https://github.com/nodejs/node/pull/24303)
* [[`59ccf65fd9`](https://github.com/nodejs/node/commit/59ccf65fd9)] - **fs**: inlinetypeof check (dexterleng) [#24390](https://github.com/nodejs/node/pull/24390)
...
* [[`454db9b4bc`](https://github.com/nodejs/node/commit/454db9b4bc)] - **http2**: replace unreachable error with assertion (Rich Trott) [#24407](https://github.com/nodejs/node/pull/24407)
* [[`ff55291c53`](https://github.com/nodejs/node/commit/ff55291c53)] - **http2**: order declarations in http2.js (ZYSzys) [#24411](https://github.com/nodejs/node/pull/24411)
* [[`704148891c`](https://github.com/nodejs/node/commit/704148891c)] - **http2**: elevate v8 namespaces of repeated references (Gagandeep Singh) [#24453](https://github.com/nodejs/node/pull/24453)
* [[`442825f7fc`](https://github.com/nodejs/node/commit/442825f7fc)] - **lib**: move encodeStr function to internal for reusable (ZYSzys) [#24242](https://github.com/nodejs/node/pull/24242)
* [[`522a6ed620`](https://github.com/nodejs/node/commit/522a6ed620)] - **lib**: refactor setupInspector in bootstrap/node.js (leeight) [#24446](https://github.com/nodejs/node/pull/24446)
* [[`db014fbd92`](https://github.com/nodejs/node/commit/db014fbd92)] - **lib**: set stderr.\_destroy to dummyDestroy (Joyee Cheung) [#24398](https://github.com/nodejs/node/pull/24398)
...
* [[`64fd3e2385`](https://github.com/nodejs/node/commit/64fd3e2385)] - ***Revert*** "**net**: partially revert "simplify Socket.prototype.\_final"" (Anna Henningsen) [#24290](https://github.com/nodejs/node/pull/24290)
...
* [[`3652f7bb78`](https://github.com/nodejs/node/commit/3652f7bb78)] - **src**: elevate namespaces for repeated entities (Sarath Govind K K) [#24475](https://github.com/nodejs/node/pull/24475)
* [[`ff4eeaecd8`](https://github.com/nodejs/node/commit/ff4eeaecd8)] - **src**: elevate namespaces of repeated artifacts (Maya Anilson) [#24429](https://github.com/nodejs/node/pull/24429)
* [[`ae8f3a8673`](https://github.com/nodejs/node/commit/ae8f3a8673)] - **src**: elevate repeated use of v8 namespaced type (Shubham Urkade) [#24427](https://github.com/nodejs/node/pull/24427)
* [[`4ae7327d29`](https://github.com/nodejs/node/commit/4ae7327d29)] - **src**: use smart pointers in cares\_wrap.cc (Daniel Bevenius) [#23813](https://github.com/nodejs/node/pull/23813)
* [[`05581aa8fe`](https://github.com/nodejs/node/commit/05581aa8fe)] - **src**: cleanclang-tidy errors in node\_file.h (Refael Ackermann) [#23793](https://github.com/nodejs/node/pull/23793)
* [[`538589edb8`](https://github.com/nodejs/node/commit/538589edb8)] - **src**: fix resource leak in node::fs::FileHandle (Refael Ackermann) [#23793](https://github.com/nodejs/node/pull/23793)
* [[`acf7e7d282`](https://github.com/nodejs/node/commit/acf7e7d282)] - **src**: refactor FillStatsArray (Refael Ackermann) [#23793](https://github.com/nodejs/node/pull/23793)
* [[`73bdb66f26`](https://github.com/nodejs/node/commit/73bdb66f26)] - **src**: elevate v8 namespaces of referenced artifacts (Kanika Singhal) [#24424](https://github.com/nodejs/node/pull/24424)
* [[`9a69d030ce`](https://github.com/nodejs/node/commit/9a69d030ce)] - **src**: reusestd::make\_unique (alyssaq) [#24132](https://github.com/nodejs/node/pull/24132)
* [[`44a1993e9d`](https://github.com/nodejs/node/commit/44a1993e9d)] - **src**: avoidextra `Persistent` in `DefaultTriggerAsyncIdScope` (Anna Henningsen) [#23844](https://github.com/nodejs/node/pull/23844)
...
* [[`30455beff7`](https://github.com/nodejs/node/commit/30455beff7)] - **stream**: correctly pause and resume after once('readable') (Matteo Collina) [#24366](https://github.com/nodejs/node/pull/24366)
* [[`33318cdc1a`](https://github.com/nodejs/node/commit/33318cdc1a)] - **stream**: donot use crypto.DEFAULT\_ENCODING in lazy\_transform.js (Joyee Cheung) [#24396](https://github.com/nodejs/node/pull/24396)
...
* [[`755bb9658e`](https://github.com/nodejs/node/commit/755bb9658e)] - **test**: use destructuring on require (Juan José Arboleda) [#24455](https://github.com/nodejs/node/pull/24455)
* [[`3f2809bf2d`](https://github.com/nodejs/node/commit/3f2809bf2d)] - **test**: fix test case in test-child-process-fork-dgram.js (gengjiawen) [#24459](https://github.com/nodejs/node/pull/24459)
* [[`6466bef8a6`](https://github.com/nodejs/node/commit/6466bef8a6)] - **test**: replace callback with arrow functions (sreepurnajasti) [#24541](https://github.com/nodejs/node/pull/24541)
* [[`d4a24e233f`](https://github.com/nodejs/node/commit/d4a24e233f)] - **test**: replace callback with arrow function (potham) [#24531](https://github.com/nodejs/node/pull/24531)
* [[`194bf968f5`](https://github.com/nodejs/node/commit/194bf968f5)] - **test**: replace anonymous function with arrow (Gagandeep Singh) [#24527](https://github.com/nodejs/node/pull/24527)
* [[`c03bd4a45b`](https://github.com/nodejs/node/commit/c03bd4a45b)] - **test**: replace anonymous function with arrow (Gagandeep Singh) [#24526](https://github.com/nodejs/node/pull/24526)
* [[`3ff3238b4b`](https://github.com/nodejs/node/commit/3ff3238b4b)] - **test**: add information to assertion (Rich Trott) [#24566](https://github.com/nodejs/node/pull/24566)
* [[`e0a2a6ddc7`](https://github.com/nodejs/node/commit/e0a2a6ddc7)] - **test**: replace anonymous function with arrow func (Gagandeep Singh) [#24525](https://github.com/nodejs/node/pull/24525)
* [[`f497e91df9`](https://github.com/nodejs/node/commit/f497e91df9)] - **test**: change anonymous closure function to arrow function (Nethra Ravindran) [#24433](https://github.com/nodejs/node/pull/24433)
* [[`0fd20ba86f`](https://github.com/nodejs/node/commit/0fd20ba86f)] - **test**: replace closure functions with arrow functions (Gagandeep Singh) [#24522](https://github.com/nodejs/node/pull/24522)
* [[`552722e328`](https://github.com/nodejs/node/commit/552722e328)] - **test**: replace anonymous function with arrow function (Gagandeep Singh) [#24529](https://github.com/nodejs/node/pull/24529)
* [[`b3e8dba132`](https://github.com/nodejs/node/commit/b3e8dba132)] - **test**: favor arrow function in callback (Pranay Kothapalli) [#24542](https://github.com/nodejs/node/pull/24542)
* [[`4bd3421e88`](https://github.com/nodejs/node/commit/4bd3421e88)] - **test**: remove unused reject handlers (Dan Foley) [#24540](https://github.com/nodejs/node/pull/24540)
* [[`0d11e83901`](https://github.com/nodejs/node/commit/0d11e83901)] - **test**: refactor test to use arrow functions (sagirk) [#24479](https://github.com/nodejs/node/pull/24479)
* [[`94e54dcd0a`](https://github.com/nodejs/node/commit/94e54dcd0a)] - **test**: replace closure with arrow function (Maya Anilson) [#24489](https://github.com/nodejs/node/pull/24489)
* [[`6e7d867c2f`](https://github.com/nodejs/node/commit/6e7d867c2f)] - **test**: using arrow functions (NoSkillGirl) [#24436](https://github.com/nodejs/node/pull/24436)
* [[`871241edec`](https://github.com/nodejs/node/commit/871241edec)] - **test**: replace anonymous closure with arrow func (suman-mitra) [#24480](https://github.com/nodejs/node/pull/24480)
* [[`76f4cb4510`](https://github.com/nodejs/node/commit/76f4cb4510)] - **test**: replace callback with arrow functions (sreepurnajasti) [#24490](https://github.com/nodejs/node/pull/24490)
* [[`cfee060aff`](https://github.com/nodejs/node/commit/cfee060aff)] - **test**: replcae anonymous closure with arrow function (Sarath Govind K K) [#24476](https://github.com/nodejs/node/pull/24476)
* [[`8ee8f41484`](https://github.com/nodejs/node/commit/8ee8f41484)] - **test**: refactor test-http-write-empty-string to use arrow functions (sagirk) [#24483](https://github.com/nodejs/node/pull/24483)
* [[`a6e595f7dd`](https://github.com/nodejs/node/commit/a6e595f7dd)] - **test**: replace anonymous closure with arrow functions (suman-mitra) [#24481](https://github.com/nodejs/node/pull/24481)
* [[`bfc2640e1d`](https://github.com/nodejs/node/commit/bfc2640e1d)] - **test**: add whatwg-encoding TextDecoder custom inspection with showHidden (ZauberNerd) [#24166](https://github.com/nodejs/node/pull/24166)
* [[`d9877017b1`](https://github.com/nodejs/node/commit/d9877017b1)] - **test**: replace anonymous closure functions with arrow functions (sagirk) [#24478](https://github.com/nodejs/node/pull/24478)
* [[`1f5a5a721b`](https://github.com/nodejs/node/commit/1f5a5a721b)] - **test**: replace anonymous closure functions with arrow function (Abhishek Dixit) [#24420](https://github.com/nodejs/node/pull/24420)
* [[`9662cf5e9e`](https://github.com/nodejs/node/commit/9662cf5e9e)] - **test**: replace anonymous closure with arrow funct (Prabu Subra) [#24439](https://github.com/nodejs/node/pull/24439)
* [[`e642050a0a`](https://github.com/nodejs/node/commit/e642050a0a)] - **test**: modify order of parameters for assertion (Mrityunjoy Saha) [#24430](https://github.com/nodejs/node/pull/24430)
* [[`ef15907f8c`](https://github.com/nodejs/node/commit/ef15907f8c)] - **test**: replace closure with arrow functions (kanishk30) [#24440](https://github.com/nodejs/node/pull/24440)
* [[`200f1274fa`](https://github.com/nodejs/node/commit/200f1274fa)] - **test**: replace anonymous closure function with arrow function (Kunda Sunil Kumar) [#24435](https://github.com/nodejs/node/pull/24435)
* [[`65d347766a`](https://github.com/nodejs/node/commit/65d347766a)] - **test**: add typeerror test for EC crypto keygen (Matteo) [#24400](https://github.com/nodejs/node/pull/24400)
* [[`658bc9f292`](https://github.com/nodejs/node/commit/658bc9f292)] - **test**: change anonymous closure functions to arrow functions (Namit Bhalla) [#24418](https://github.com/nodejs/node/pull/24418)
* [[`bfa1008cc8`](https://github.com/nodejs/node/commit/bfa1008cc8)] - **test**: use print() function on both Python 2 and 3 (cclauss) [#24485](https://github.com/nodejs/node/pull/24485)
* [[`330019cef2`](https://github.com/nodejs/node/commit/330019cef2)] - **test**: favor arrow functions in callbacks (UjjwalUpadhyay) [#24425](https://github.com/nodejs/node/pull/24425)
* [[`01532b8b8b`](https://github.com/nodejs/node/commit/01532b8b8b)] - **test**: replace anonymous closure functions with arrow function (Amanpreet) [#24417](https://github.com/nodejs/node/pull/24417)
* [[`d148bfc318`](https://github.com/nodejs/node/commit/d148bfc318)] - **test**: fix arguments order in napi test\_exception (kanishk30) [#24413](https://github.com/nodejs/node/pull/24413)
* [[`e41833f6fc`](https://github.com/nodejs/node/commit/e41833f6fc)] - **test**: fix the arguments order in `assert.strictEqual` (Jay Arthanareeswaran) [#24416](https://github.com/nodejs/node/pull/24416)
* [[`07d9eb6c2b`](https://github.com/nodejs/node/commit/07d9eb6c2b)] - **test**: replace closure with arrow functions (Amanpreet) [#24438](https://github.com/nodejs/node/pull/24438)
* [[`c16a739e86`](https://github.com/nodejs/node/commit/c16a739e86)] - **test**: change callback function to arrow function (Jay Arthanareeswaran) [#24419](https://github.com/nodejs/node/pull/24419)
* [[`359004c120`](https://github.com/nodejs/node/commit/359004c120)] - **test**: fix the arguments order in `assert.strictEqual` (apoorvanand) [#24431](https://github.com/nodejs/node/pull/24431)
* [[`7c8157f4de`](https://github.com/nodejs/node/commit/7c8157f4de)] - **test**: assertion equality fix (NoSkillGirl) [#24422](https://github.com/nodejs/node/pull/24422)
* [[`63735da990`](https://github.com/nodejs/node/commit/63735da990)] - **test**: remove unused function arguments in async-hooks tests (Simon Bruce) [#24406](https://github.com/nodejs/node/pull/24406)
* [[`d73b8f046b`](https://github.com/nodejs/node/commit/d73b8f046b)] - **test**: fix actual parameter order for 'assert.strictEqual' (Selvaraj) [#24428](https://github.com/nodejs/node/pull/24428)
* [[`e77a4c6633`](https://github.com/nodejs/node/commit/e77a4c6633)] - **test**: swapactual&optional params (Nikhil M) [#24426](https://github.com/nodejs/node/pull/24426)
* [[`5b45642fd1`](https://github.com/nodejs/node/commit/5b45642fd1)] - **test**: skiptest that use --tls-v1.x flags (Daniel Bevenius) [#24376](https://github.com/nodejs/node/pull/24376)
* [[`70e7d539c6`](https://github.com/nodejs/node/commit/70e7d539c6)] - **test**: change callback function to arrow function (Lakshmi Shanmugam) [#24421](https://github.com/nodejs/node/pull/24421)
* [[`e868fddb35`](https://github.com/nodejs/node/commit/e868fddb35)] - **test**: replace anonymous closure for test-http-expect-handling.js (Jayasankar) [#24423](https://github.com/nodejs/node/pull/24423)
* [[`a3b971b5f0`](https://github.com/nodejs/node/commit/a3b971b5f0)] - **test**: replace callback functions with arrow functions (potham) [#24432](https://github.com/nodejs/node/pull/24432)
* [[`48e6be0390`](https://github.com/nodejs/node/commit/48e6be0390)] - **test**: use arrow functions for callbacks (Pushkal B) [#24444](https://github.com/nodejs/node/pull/24444)
* [[`4937c92786`](https://github.com/nodejs/node/commit/4937c92786)] - **test**: replace anonymous closure function (Jayasankar) [#24415](https://github.com/nodejs/node/pull/24415)
* [[`7262850086`](https://github.com/nodejs/node/commit/7262850086)] - **test**: fixed the arguments order in `assert.strictEqual` (Lakshmi Shanmugam) [#24414](https://github.com/nodejs/node/pull/24414)
* [[`8ac75c8d5f`](https://github.com/nodejs/node/commit/8ac75c8d5f)] - **test**: use destructuring and remove unused arguments (Julia) [#24375](https://github.com/nodejs/node/pull/24375)
* [[`8baad9c355`](https://github.com/nodejs/node/commit/8baad9c355)] - **test**: https agent clientcertengine coverage (Osmond van Hemert) [#24248](https://github.com/nodejs/node/pull/24248)
* [[`979ea16514`](https://github.com/nodejs/node/commit/979ea16514)] - **test**: remove unused function arguments in async-hooks tests (Rich Trott) [#24368](https://github.com/nodejs/node/pull/24368)
...
* [[`6cad1b6877`](https://github.com/nodejs/node/commit/6cad1b6877)] - **test**: deepobject to table not covered (Osmond van Hemert) [#24257](https://github.com/nodejs/node/pull/24257)
...
* [[`9970d562c6`](https://github.com/nodejs/node/commit/9970d562c6)] - **test**: testadd and remove for lib/domain (Petar Dodev) [#24163](https://github.com/nodejs/node/pull/24163)
...
* [[`d04c3c2718`](https://github.com/nodejs/node/commit/d04c3c2718)] - **test**: movebenchmark tests out of main test suite (Rich Trott) [#24265](https://github.com/nodejs/node/pull/24265)
...
* [[`4b9518dba3`](https://github.com/nodejs/node/commit/4b9518dba3)] - **test**: movetest-fs-watch-system-limit from sequential to pummel (Marcus Scott) [#23692](https://github.com/nodejs/node/pull/23692)
...
* [[`380789eb68`](https://github.com/nodejs/node/commit/380789eb68)] - **test**: fixeargument order in assert.strictEqual (Marc Posth) [#24140](https://github.com/nodejs/node/pull/24140)
...
* [[`abf9bd15db`](https://github.com/nodejs/node/commit/abf9bd15db)] - **test**: swapexpected and actual in assert.strictEqual (Florin-Daniel BÎLBÎE) [#24146](https://github.com/nodejs/node/pull/24146)
...
* [[`11a84a7b32`](https://github.com/nodejs/node/commit/11a84a7b32)] - **test**: swapthe order of arguments (Musa Hamwala) [#24134](https://github.com/nodejs/node/pull/24134)
...
* [[`b16311b19f`](https://github.com/nodejs/node/commit/b16311b19f)] - **test**: marktest-vm-timeout-\* known issue tests flaky (James M Snell) [#23743](https://github.com/nodejs/node/pull/23743)
* [[`8b4502b574`](https://github.com/nodejs/node/commit/8b4502b574)] - **tls**: destroy TLS socket if StreamWrap is destroyed (Anna Henningsen) [#24290](https://github.com/nodejs/node/pull/24290)
* [[`5733849ed4`](https://github.com/nodejs/node/commit/5733849ed4)] - **tls**: do not rely on 'drain' handlers in StreamWrap (Anna Henningsen) [#24290](https://github.com/nodejs/node/pull/24290)
* [[`3170cb49d8`](https://github.com/nodejs/node/commit/3170cb49d8)] - **tls**: throwif protocol too long (Andre Jodat-Danbrani) [#23606](https://github.com/nodejs/node/pull/23606)
* [[`2864dcf820`](https://github.com/nodejs/node/commit/2864dcf820)] - **tools**: update to remark-lint-preset-node@1.2.0 (Rich Trott) [#24391](https://github.com/nodejs/node/pull/24391)
* [[`c774baf370`](https://github.com/nodejs/node/commit/c774baf370)] - **tools**: fix`make lint-md-rollup` and run it (Daijiro Wachi) [#24333](https://github.com/nodejs/node/pull/24333)
* [[`ba10955f41`](https://github.com/nodejs/node/commit/ba10955f41)] - **tools**: update remark-lint to v6.0.3 from v6.0.2 (Daijiro Wachi) [#24333](https://github.com/nodejs/node/pull/24333)
* [[`16f0f103de`](https://github.com/nodejs/node/commit/16f0f103de)] - **tools**: update remark version to v10 from v8 (Daijiro Wachi) [#24333](https://github.com/nodejs/node/pull/24333)
...
* [[`734fe5fe1c`](https://github.com/nodejs/node/commit/734fe5fe1c)] - **util**: remove unreachable branch (rahulshuklab4u) [#24447](https://github.com/nodejs/node/pull/24447)
